...
public class FreeAtHomeTouchHandler extends FreeAtHomeBaseHandler {
    ...
    private FreeAtHomeTouchConfig m_Configuration = new FreeAtHomeTouchConfig();
    ...
    @Override
    public void setUp() {
        m_Configuration = getConfigAs(FreeAtHomeTouchConfig.class);
        ...
        if (bridge != null) {
            ...
            m_UpdateChannels.add(new FreeAtHomeUpdateChannel(this,
                    FreeAtHomeBindingConstants.TOUCH_SWITCH_THING_CHANNEL, new DefaultOnOffTypeConverter(),
            ...
            m_UpdateChannels.add(new FreeAtHomeUpdateChannel(this, FreeAtHomeBindingConstants.TOUCH_ECO_THING_CHANNEL,
                    new EcoModeOnOffTypeConverter(), m_Configuration.deviceId, m_Configuration.channelId,
                    m_Configuration.dataPointIdEcoUpdate));
