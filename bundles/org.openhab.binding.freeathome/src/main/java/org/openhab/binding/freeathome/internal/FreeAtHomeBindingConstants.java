...
public class FreeAtHomeBindingConstants {
    ...
    public final static String VIRTUALSWITCH_THING_CHANNEL = "fh_switch_channel";
    public final static String MOTIONSWITCH_THING_CHANNEL = "fh_switch_channel";
    ...
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Stream
            .of(RAFFSTORE_THING_TYPEUID, BRIDGE_THING_TYPEUID, SCENE_THING_TYPEUID, SCENARIO_SELECTOR_THING_TYPEUID,
                    DUMMY_THING_TYPEUID, SWITCH_THING_TYPEUID, THERMOSTAT_THING_TYPEUID, DIMMER_THING_TYPEUID,
                    TOUCH_THING_TYPEUID, VIRTUALSWITCH_THING_TYPEUID, MOTIONSWITCH_THING_TYPEUID, WEATHER_THING_TYPEUID)
